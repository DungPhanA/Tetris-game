...
class Tetris:
    def __init__(self, app):
        ...
        self.end_sound = mixer.Sound('music/Voicy_Game Over- Tetris Sounds.mp3')
        self.score_sound = mixer.Sound('music/Voicy_Next Level- Tetris Sounds.mp3')
        mixer.init()
        mixer.music.set_volume(0.3)
        mixer.music.load('music/TetrisGameBoy-V.A-3323727.mp3')
        mixer.music.play(-1)
